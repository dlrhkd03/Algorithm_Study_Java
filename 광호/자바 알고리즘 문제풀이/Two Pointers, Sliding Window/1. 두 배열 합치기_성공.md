...
public class Main {
    ...
    static void solution() throws IOException {
        ...
        int lt1 = 0, lt2 = 0;
        for (int i = 0; i < N + M; i++) {
            if (lt1 == N || lt2 == M) break;
            if (arr1[lt1] > arr2[lt2]) {
                sb.append(arr2[lt2++]).append(" ");
            } else {
                sb.append(arr1[lt1++]).append(" ");
            }
        }
        if (lt1 == N) {
            for (int i = lt2; i < M; i++) sb.append(arr2[i]).append(" ");
        }
        if (lt2 == M) {
            for (int i = lt1; i < N; i++) sb.append(arr1[i]).append(" ");
        }
    }
